              ...
              <div className="col-6">
                <div className="profile-info-section">
                  <div className="profile-info">
                    ...
                    <input
                      type="text"
                      value={this.props.profileData.userFullName}
                      name="fullName"
                    />
                    <label>Username</label>
                    <input
                      type="text"
                      value={auth.getStoreState(USER_NAME)}
                      name="userName"
                    />
                    <label>Phone Number</label>
                    <input
                      type="number"
                      value={this.props.profileData.userPhone}
                      name="phone"
                    />
                    <label>Email</label>
                    <input
                      type="email"
                      value={this.props.profileData.userEmail}
                      name="email"
                    />
                    <label>Company Name</label>
                    <input
                      type="text"
                      value={this.props.profileData.companyName}
                      name="companyName"
                    />
                    <label>Domain Name</label>
                    <input
                      type="text"
                      value={this.props.profileData.domainName}
                      name="domainName"
                    />
